...
description: Portfolio-level performance measurement for NSE equity — return metrics, risk metrics, risk-adjusted ratios, rolling analysis, and reports
---

> **IROS context:** Apply using IROS snapshot data only (`backend/app/services/last_market_snapshot.json`) + live APIs; Indian equity/NSE context; never invent metrics.
