  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="relative flex min-h-[240px] sm:min-h-[320px] md:min-h-[360px] flex-col items-center justify-center p-8 text-center">
        ...
        <p className="mt-2 max-w-sm text-xs leading-relaxed text-slate-500">Select a stock from the Swing Portfolio to load its live Trendlyne checklist widget.</p>
      </div>
    </div>
  );
}
