      ...
      {open && (
        <>
          <motion.button
            key="drawer-overlay"
            type="button"
            className="fixed inset-0 z-[90] bg-slate-950/75"
      ...
      <div className="z-20 shrink-0 border-b border-slate-200 bg-[var(--terminal-panel)]">
        ...
        <div className="right-drawer-tabs flex px-2 sm:px-5 overflow-x-auto desk-scroll-x flex-nowrap">
          ...
          <button
            ...
            className={`relative py-2.5 px-1 min-h-11 shrink-0 text-[10px] font-bold uppercase tracking-wider transition-all duration-200 ${
         ...
         {activeTab === "aiNews" && (
           ticker ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-slate-400">
              ...
              <p className="text-xs">Select a ticker from the Swing Portfolio</p>
