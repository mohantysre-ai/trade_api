    ...
    def _run(self) -> None:
        ...
        while not self._stop:
            try:
                ...
                # The SDK invokes ``on_open`` with its low-level WebSocketApp.
                # Subscription methods live on SmartWebSocketV2, so retain the
                # wrapper here instead of forwarding the callback argument.
