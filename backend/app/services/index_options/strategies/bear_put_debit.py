"""BEAR_PUT_DEBIT_SPREAD — Phase 2 debit spread strategy."""
...
class BearPutDebitSpread(OptionStrategy):
    ...
    def eligible(self, context: IndexOptionContext) -> bool:
        ...
        if context.structure.get("status") != "CONFIRMED":
            return False
        if not executable_rows(context.chain, "PUT"):
            return False
        return True
    ...
    def build(self, context: IndexOptionContext) -> StrategyResult:
            ...
            return StrategyResult(
                ...
                extra={
                    ...
                    "gates": {
                        ...
                        "putLegsAvailable": bool(executable_rows(context.chain, "PUT")),
                    },
                },
            )
        ...
        economics = debit_spread_economics(legs, "PUT")
