"""LONG_STRANGLE — long volatility expansion with OTM options."""

from __future__ import annotations

from typing import Any

from ..strike_selection import build_strangle_legs, executable_rows
...
class LongStrangleStrategy(OptionStrategy):
    ...
    def build(self, context: IndexOptionContext) -> StrategyResult:
        ...
        legs = build_strangle_legs(
            context.chain,
            spot=context.spot,
            strategy_position_id=context.snapshot_id or "STRANGLE",
            expiry=context.expiry,
        )
        if legs is None:
            return StrategyResult(
