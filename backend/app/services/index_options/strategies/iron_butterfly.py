"""IRON_BUTTERFLY — Phase 4, feature-gated."""

from __future__ import annotations

from ..config import MIN_BUTTERFLY_REWARD_RISK
from ..economics_v2 import iron_butterfly_economics
from ..strike_selection import build_iron_butterfly_legs
...
class IronButterflyStrategy(OptionStrategy):
    ...
    def build(self, context: IndexOptionContext) -> StrategyResult:
        ...
        economics = iron_butterfly_economics(legs)
        ...
        return structured_result(
            ...
            economics,
            state="ELIGIBLE",
            reason="IRON_BUTTERFLY_GATES_PASSED",
            eligible=True,
        )
