"""BEAR_CALL_CREDIT_SPREAD — defined-risk credit spread for bearish outlook."""
...
class BearCallCreditSpread(OptionStrategy):
    strategy_id = "BEAR_CALL_CREDIT_SPREAD"
    ...
    def build(self, context: IndexOptionContext) -> StrategyResult:
        ...
        breakevens = [risk.get("upperBreakEven")] if risk.get("upperBreakEven") is not None else []
